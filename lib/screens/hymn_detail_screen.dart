...
class HymnDetailScreen extends StatelessWidget {
  ...
  Future<void> _downloadAudio(BuildContext context) async {
    ...
    try {
      ...
      _showErrorSnackbar(context, 'Could not open download link.');
    }
  }
  ...
  Widget build(BuildContext context) {
    // Show the prompt every time this screen loads
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
                    ...
                    return Card(
                      ...
                      child: Padding(
                        padding: const EdgeInsets.all(
                            20), // slightly more horizontal padding
                        child: Column(
                          crossAxisAlignment: CrossAxisAlignment.center,
                          children: [
          ...
          // Sticky bottom audio controls (unchanged)
          Container(
            ...
            child: SafeArea(
              ...
              child: Consumer<AudioProvider>(
                builder: (context, audioProvider, child) {
                  final isPlaying =
                      audioProvider.playingHymnNumber == hymn.number;
